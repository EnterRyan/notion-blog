...
export default function TagSumList({tagsCount}:TagSumListType){
  ...
  return (
    <div className="w-full h-full p-2 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow">
      <h3 className="text-base font-bold text-gray-900 dark:text-white mb-3">태그별 포스팅 개수</h3>
      <div className="h-full flex flex-row flex-wrap overflow-y-scroll">
